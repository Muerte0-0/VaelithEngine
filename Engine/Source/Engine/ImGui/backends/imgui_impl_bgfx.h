...
// Call this immediately after bgfx::frame() each tick.
// It creates/resizes framebuffers for any viewports that changed this frame.
// bgfx::createFrameBuffer(nwh) is only safe between frames, never mid-frame.
