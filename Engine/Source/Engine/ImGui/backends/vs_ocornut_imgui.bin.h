...
// Stub definitions for renderer variants not compiled by shaderc yet.
// bgfx's BGFX_EMBEDDED_SHADER macro requires these symbols to be defined;
// a null pointer signals "not available" and bgfx will skip this variant.
static const uint8_t* vs_ocornut_imgui_dxbc = nullptr;
static const uint32_t vs_ocornut_imgui_dxbc_size = 0;
static const uint8_t* vs_ocornut_imgui_dxil = nullptr;
static const uint32_t vs_ocornut_imgui_dxil_size = 0;
static const uint8_t* vs_ocornut_imgui_wgsl = nullptr;
static const uint32_t vs_ocornut_imgui_wgsl_size = 0;